package com.example.zjl.myrecyclerview.adapter2;

import com.example.zjl.myrecyclerview.R;
import com.example.zjl.myrecyclerview.bean2.Node;
import com.example.zjl.myrecyclerview.bean2.TreeNodeId;
import com.example.zjl.myrecyclerview.bean2.TreeNodeLabel;
import com.example.zjl.myrecyclerview.bean2.TreeNodePid;
...
public class TreeHelper {
    ...
    private static void setNodeIcon(Node node) {
        if (node.getChildren().size() > 0 && node.isExpand()) {
            node.setIcon(R.drawable.android_logo);
